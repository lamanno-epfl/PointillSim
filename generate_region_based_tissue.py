...
OUTPUT_FOLDER = "region_based_tissue_output3"
...
CELL_TYPE_COLORS = {
    ...
    ID_STROMAL_1:    '#D2B48C',  # Tan
    ID_STROMAL_2:    '#F5DEB3',  # Wheat
}
...
# ---------- CELL MORPHOLOGY ----------
#                       BlueCore CyanCore GrnDk  GrnLt  Yel    Org    Red    RedDp  PurDk  PurLt  Strom1 Strom2
CELL_SIZES =            [8,      8,       9,     9,     9,     9,     8,     8,     10,    10,    9,     9]
CELL_SIZE_VARIATION =   [0.20,   0.20,    0.20,  0.20,  0.20,  0.20,  0.20,  0.20,  0.25,  0.25,  0.20,  0.20]
CELL_ANISOTROPY =       [0.85,   0.85,    0.80,  0.80,  0.80,  0.80,  0.90,  0.90,  0.75,  0.75,  0.85,  0.85]
CELL_ANISO_VARIATION =  [0.10,   0.10,    0.10,  0.10,  0.10,  0.10,  0.10,  0.10,  0.15,  0.15,  0.10,  0.10]
...
BACKGROUND_TYPES = [ID_STROMAL_1, ID_STROMAL_2]
BACKGROUND_PROPORTIONS = [0.50, 0.50]
